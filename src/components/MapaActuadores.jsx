...
//     };
//   }, [ubicacion, data]);
//   // Obtener estado actuadores por MQTT
//   useEffect(() => {
...
//     };
//   }, []);
//   // Calculo distancia para activar actuadores
//   useEffect(() => {
//     const client = mqtt.connect("ws://test.mosquitto.org:8080/mqtt");
//     client.on("connect", () => {
//       client.subscribe("TFM_actuadores");
//     });
//     if (ubicacion.x && ubicacion.y && data) {
...
//         var estadoActuador = getActuatorValue(closestActuator.name);
//         console.log(estadoActuador);
//         if (estadoActuador == 0) {
//           const nuevoEstado = 1;
...
//           setTimeout(() => {
//             const nuevoEstadoApagado = 0;
//             const actualizarApagado = JSON.stringify({
//               ...actuadoresMQTT,
//               [closestActuator.name]: nuevoEstadoApagado,
//             });
//             client.publish("TFM_actuadores", actualizarApagado);
//             console.log(actualizarApagado);
//           }, 12000);
//         }
...
//     }
//   }, [ubicacion, data]);
//   // Calculo distancia para activar luces
...
//       client.subscribe("TFM_luces");
//     });
//     if (ubicacion.x && ubicacion.y && luces) {
...
//         var estadoLuz = getLuzValue(closestLight.name);
//         if (estadoLuz == 0) {
...
//           setTimeout(() => {
//             const estado = 0;
//             const apagarLuz = JSON.stringify({
//               ...lucesMQTT,
//               [closestLight.name]: estado,
//             });
//             client.publish("TFM_luces", apagarLuz);
//           }, 12000);
//         }
...
//         <p className="">
//           Luz Cercana: <span className="font-bold">{cercaniaLuces}</span>
//         </p>
      ...
      <div className="p-8 mt-5 text-blue-600">
        ...
        <p className="">
          ...
          <span className="font-bold">
            {cercaniaLuces} Distancia: {distanciaLuces}
          </span>
        </p>
